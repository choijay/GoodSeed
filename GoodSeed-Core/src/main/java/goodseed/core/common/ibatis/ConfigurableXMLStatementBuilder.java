...
/**
*
* The class ConfigurableXMLStatementBuilder<br>
* <br>
* 쿼리 Statement를 파싱하는 클래스<br>
* <br>
* <br>
...
*
*/
//public class ConfigurableXMLStatementBuilder extends BaseBuilder { 
public class ConfigurableXMLStatementBuilder extends XMLStatementBuilder {

	private MapperBuilderAssistant builderAssistant;
	private XNode context;
	private String requiredDatabaseId;

	public ConfigurableXMLStatementBuilder(Configuration configuration, MapperBuilderAssistant builderAssistant, XNode context) {
		this(configuration, builderAssistant, context, null);
		//	  super(configuration, builderAssistant, context, null);
	}
	...
	public void parseStatementNode() {
		...
		// applicationProperties.xml 설정 값
		Integer fetchSize = Config.getInteger("defaultFetchSize", 50);
